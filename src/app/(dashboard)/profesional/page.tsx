...
function DashboardContent() {
    return (
        <div className="space-y-8">
            ...
            <div
                className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-accent/8 via-background to-primary/6 border border-border/50 p-6 sm:p-8"
            ...
            >
                ...
                <div className="relative flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    ...
                    <Link
                        ...
                        className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-accent to-primary px-5 py-2.5 text-sm font-medium text-primary-foreground shadow-lg shadow-accent/20 transition-opacity hover:opacity-90 shrink-0"
                    >
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                ...
                >
                    ...
                    <CardContent className="p-5">
                        <div className="flex items-center justify-between mb-3">
                            <span className="text-sm font-medium text-muted-foreground">Clientes atendidos</span>
                ...
                >
                    ...
                    <CardContent className="p-5">
                        ...
                        <p className="text-4xl font-bold tracking-tight">5.0</p>
            ...
            >
                ...
                <Card className="lg:col-span-3 border-border/50">
                    ...
                    <CardContent>
                        <div className="flex flex-col items-center justify-center py-12 text-center">
                            ...
                            <p className="text-sm text-muted-foreground mb-1">No hay citas programadas para hoy</p>
                            <p className="text-xs text-muted-foreground/60">Las citas aparecerán aquí cuando sean agendadas</p>
                        </div>
                    </CardContent>
                </Card>
                ...
                <div className="lg:col-span-2 grid gap-3 content-start">
                        ...
                        <Card className="border-border/50 hover:border-primary/30 hover:shadow-lg hover:shadow-primary/5 transition-all duration-300">
                            <CardContent className="p-5 flex items-start gap-4">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-xs text-muted-foreground mt-0.5">Ver agenda completa</p>
                                </div>
                    ...
                    <Link href="/profesional/clientes" className="group">
                        <Card className="border-border/50 hover:border-accent/30 hover:shadow-lg hover:shadow-accent/5 transition-all duration-300">
                            <CardContent className="p-5 flex items-start gap-4">
                                ...
                                <div className="flex-1 min-w-0">
                                    <p className="font-semibold text-sm group-hover:text-accent transition-colors">Mis Clientes</p>
                                    <p className="text-xs text-muted-foreground mt-0.5">Historial y contacto</p>
                                </div>
                    ...
                    <Link href="/perfil" className="group">
                        <Card className="border-border/50 hover:border-emerald-500/30 hover:shadow-lg hover:shadow-emerald-500/5 transition-all duration-300">
                            <CardContent className="p-5 flex items-start gap-4">
                                ...
                                <div className="flex-1 min-w-0">
                                    <p className="font-semibold text-sm group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors">Mi Perfil</p>
                                    <p className="text-xs text-muted-foreground mt-0.5">Datos y preferencias</p>
                                </div>
